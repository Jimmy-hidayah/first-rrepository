...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-4">
        ...
        <a class="btn btn-success btn-sm" href="">List Products</a>
    </div>
                    ...
                    <div class="card-body p-0">
                        <form action="{{ route('produk.store') }}" method="post">
                            ...
                            <div class="form-group">
                              <label >Product</label>
                              <input type="text" name="nama" class="form-control" placeholder=" add your category">
                            </div>
                            <div class="form-group">
                              <label >Price</label>
                              <input type="text" name="harga" class="form-control" placeholder=" add your category">
                            </div>

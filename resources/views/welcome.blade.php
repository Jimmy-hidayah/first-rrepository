      ...
      <div class="row">
          ...
          <div class="header-text">
            ...
            <div class="buttons">
              ...
              <div class="main-button">
                <a href="https://youtu.be/gfGuPd1CELo" target="_blank">Watch Our Videos</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-5 offset-lg-1">
          <div class="owl-banner owl-carousel">
            <div class="item">
              <img src="{{asset('template/assets/images/banner-01.png')}}" alt="">
            </div>
            <div class="item">
              <img src="{{asset('template/assets/images/banner-02.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="categories">
            <div class="row">
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-01.png')}}" alt="">
                  </div>
                  <h4>Blockchain</h4>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-02.png')}}" alt="">
                  </div>
                  <h4>Digital Art</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-03.png')}}" alt="">
                  </div>
                  <h4>Music Art</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-04.png')}}" alt="">
                  </div>
                  <h4>Virtual World</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-05.png')}}" alt="">
                  </div>
                  <h4>Valuable</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="{{asset('template/assets/images/icon-06.png')}}" alt="">
                  </div>
                  <h4>Triple NFT</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
  ...
  <div class="create-nft" >
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="main-button">
            <a href="{{route('register')}}">Create Your NFT Now</a>
          </div>
        </div>
        <div class="col-lg-4">
            ...
            <div class="col-lg-6 currently-market-item all msc">
              <div class="item">
                <div class="left-image">
                  <img src="{{asset('template/assets/images/market-01.jpg')}}" alt="" style="border-radius: 20px; min-width: 195px;">
                </div>
                <div class="right-content">
                  <h4>Music Art Super Item</h4>
                  <span class="author">
                    <img src="{{asset('template/assets/images/author.jpg')}}" alt="" style="max-width: 50px; border-radius: 50%;">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          &nbsp;&nbsp;
          Designed by <a title="HTML CSS Templates" rel="sponsored" href="https://templatemo.com" target="_blank">Jimmy</a></p>
        </div>
      </div>
    </div>
  </footer>
